...
const IS_PROD = APP_CONST.IS_PROD;
...
const logger = createLogger({
  ...
  transports: [
    new transports.File({ filename: ERROR_LOG_FILE, level: ERROR_LOG_LEVEL }),
    new transports.File({ filename: COMBINED_LOG_FILE, level: DEBUG_LOG_LEVEL })
  ]
});
